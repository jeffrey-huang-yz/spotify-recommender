...
const Login = () => {
  ...
  return (
    <div>
      ...
      <p>
      Welcome to <span className='purple-text'>disk</span>overy! This website helps you discover new music based on your specific preferences. <br></br>Log in with your <span className='green-text'> Spotify account</span> to get started so you can add music to playlists in real time.
      </p>
    </div>
    );
  }
